...
{
	int r,g,b;
	//colorTemp(3000.0 * exp(fade*(age)), r, g, b);

	//ofSetColor(r, g, b, 128*exp(fade*age));
	ofSetColor(55, 55, 55, 64*exp(fade*age));

	ofFill();
	ofCircle(x, y, radius*(1.0/exp(fade*age)));
}
